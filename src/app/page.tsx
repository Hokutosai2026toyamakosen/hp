    ...
    <div>
      <main className="top-page">
          <div className="mainvisual">
              <img src="/img/common/mainlogo.jpg" alt="" />
          </div>
          ...
          <section className="products fadein">
              ...
              <div className="products-list-area">
                  <ul className="products-list">
                      <li>
                          <img src="/img/top/products1.jpg" alt="" />
                      </li>
                      <li>
                          <img src="/img/top/products2.jpg" alt="" />
                      </li>
                      <li>
                          <img src="/img/top/products3.jpg" alt="" />
                      </li>
                      <li>
                          <img src="/img/top/products4.jpg" alt="" />
                      </li>
                      <li>
                          <img src="/img/top/products5.jpg" alt="" />
                      </li>
                      <li>
                          <img src="/img/top/products6.jpg" alt="" />
                      </li>
                  </ul>
                  <ul className="products-list">
                      <li>
          ...
          <section className="works fadein">
              <div className="text">
                  ...
                  <p className="description">また、情報を発信するニュースや当日のアクセスの方法も掲載しています。</p>
              ...
              <ul className="works-list">
                  <li>
                      <img src="/img/top/works1.jpg" alt="" />
                  </li>
                  <li>
                      <img src="/img/top/works2.jpg" alt="" />
                  </li>
                  <li>
                      <img src="/img/top/works3.jpg" alt="" />
                  </li>
                  <li>
                      <img src="/img/top/works4.jpg" alt="" />
                  </li>
              </ul>
          </section>
